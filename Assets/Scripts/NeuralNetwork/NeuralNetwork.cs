...
public class NeuralNetwork : IComparable<NeuralNetwork>
{
    ...
    public NeuralNetwork(int[] layers, string path)
    {
        saveAndLoadSystem = new SaveAndLoadSystem(path);
    ...
    public void Save()
    {
        saveAndLoadSystem.Save(biases, weights);
    }

    public void Load()
    {
        saveAndLoadSystem.Load(ref biases, ref weights);
    }
}
